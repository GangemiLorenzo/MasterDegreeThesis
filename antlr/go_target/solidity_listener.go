...
type SolidityListener interface {
	...
	// EnterUsingForObject is called when entering the usingForObject production.
	EnterUsingForObject(c *UsingForObjectContext)

	// EnterUsingForObjectDirective is called when entering the usingForObjectDirective production.
	EnterUsingForObjectDirective(c *UsingForObjectDirectiveContext)

	// EnterUserDefinableOperators is called when entering the userDefinableOperators production.
	EnterUserDefinableOperators(c *UserDefinableOperatorsContext)
	...
	// EnterMappingKeyName is called when entering the mappingKeyName production.
	EnterMappingKeyName(c *MappingKeyNameContext)

	// EnterMappingValueName is called when entering the mappingValueName production.
	EnterMappingValueName(c *MappingValueNameContext)
	...
	// EnterInlineAssemblyStatementFlag is called when entering the inlineAssemblyStatementFlag production.
	EnterInlineAssemblyStatementFlag(c *InlineAssemblyStatementFlagContext)
	...
	// ExitUsingForObject is called when exiting the usingForObject production.
	ExitUsingForObject(c *UsingForObjectContext)

	// ExitUsingForObjectDirective is called when exiting the usingForObjectDirective production.
	ExitUsingForObjectDirective(c *UsingForObjectDirectiveContext)

	// ExitUserDefinableOperators is called when exiting the userDefinableOperators production.
	ExitUserDefinableOperators(c *UserDefinableOperatorsContext)
	...
	// ExitMappingKeyName is called when exiting the mappingKeyName production.
	ExitMappingKeyName(c *MappingKeyNameContext)

	// ExitMappingValueName is called when exiting the mappingValueName production.
	ExitMappingValueName(c *MappingValueNameContext)
	...
	// ExitInlineAssemblyStatementFlag is called when exiting the inlineAssemblyStatementFlag production.
	ExitInlineAssemblyStatementFlag(c *InlineAssemblyStatementFlagContext)
