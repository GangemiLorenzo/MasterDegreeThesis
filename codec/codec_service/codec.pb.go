...
type EncodeRequest struct {
	...
	SmartContractCode string `protobuf:"bytes,1,opt,name=smartContractCode,proto3" json:"smartContractCode,omitempty"` // Input smart contract code to be encoded into JSON
}
...
func (x *EncodeRequest) GetSmartContractCode() string {
	if x != nil {
...
type EncodeResponse struct {
	...
	JsonStructure string `protobuf:"bytes,1,opt,name=jsonStructure,proto3" json:"jsonStructure,omitempty"` // Encoded JSON structure of the smart contract
}
...
func (x *EncodeResponse) GetJsonStructure() string {
	if x != nil {
...
type DecodeRequest struct {
	...
	JsonStructure string `protobuf:"bytes,1,opt,name=jsonStructure,proto3" json:"jsonStructure,omitempty"` // Input JSON structure to be decoded back into smart contract code
}
...
func (x *DecodeRequest) GetJsonStructure() string {
	if x != nil {
		return x.JsonStructure
	}
	return ""
...
type DecodeResponse struct {
	...
	SmartContractCode string `protobuf:"bytes,1,opt,name=smartContractCode,proto3" json:"smartContractCode,omitempty"` // Decoded smart contract code
}
...
func (x *DecodeResponse) GetSmartContractCode() string {
	if x != nil {
		return x.SmartContractCode
	}
	return ""
...
var file_codec_proto_rawDesc = []byte{
	...
	,
