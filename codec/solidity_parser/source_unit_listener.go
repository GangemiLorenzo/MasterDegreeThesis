...
func NewSourceUnitListere() *SourceUnitListener {
...
func (s *SourceUnitListener) LastPragmaDirective() *PragmaDirective {
	...
	// Return a pointer to the last element in the slice
...
// func (s *SourceUnitListener) EnterImportPath(ctx *parser.ImportPathContext) { fmt.Println("here") }

// // ExitImportPath is called when production importPath is exited.
// func (s *SourceUnitListener) ExitImportPath(ctx *parser.ImportPathContext) { fmt.Println("here") }
...
// func (s *SourceUnitListener) EnterEnumValue(ctx *parser.EnumValueContext) { fmt.Println("here") }

// // ExitEnumValue is called when production enumValue is exited.
// func (s *SourceUnitListener) ExitEnumValue(ctx *parser.EnumValueContext) { fmt.Println("here") }
...
// func (s *SourceUnitListener) ExitEnumDefinition(ctx *parser.EnumDefinitionContext) { fmt.Println("here") }
...
// func (s *SourceUnitListener) ExitEventParameter(ctx *parser.EventParameterContext) { fmt.Println("here") }
...
// func (s *SourceUnitListener) EnterMapping(ctx *parser.MappingContext) { fmt.Println("here") }

// // ExitMapping is called when production mapping is exited.
// func (s *SourceUnitListener) ExitMapping(ctx *parser.MappingContext) { fmt.Println("here") }
