...
func (su *ModifierDefinition) GetId() string {
	return su.Id
}

func (su *ModifierDefinition) SetDescription(description string) {
	su.Description = description
}

func (su *ModifierDefinition) UpdateDescription(id string, description string) {
	if su.Id == id {
